...
const BackgroundBlobs = () => {
  ...
  useEffect(() => {
    ...
    const particleTexture = createBokehTexture(false);
    const auroraTexture = createBokehTexture(true);
    ...
    const aurora1Geo = new THREE.PlaneGeometry(18, 18);
    const aurora1Mat = new THREE.MeshBasicMaterial({
      map: auroraTexture,
      transparent: true,
      opacity: 0.18,
      blending: THREE.AdditiveBlending,
    ...
    const aurora2Geo = new THREE.PlaneGeometry(22, 22);
    ...
    const aurora3Geo = new THREE.PlaneGeometry(14, 14);
    const aurora3Mat = new THREE.MeshBasicMaterial({
      map: auroraTexture,
      transparent: true,
      opacity: 0.22,
      blending: THREE.AdditiveBlending,
